...
public class ColorManager extends BaseManager<Color, ColorRepository, GetColorResponse, GetColorListResponse, AddColorRequest, UpdateColorRequest> implements ColorService {
    ...
    public ColorManager(ColorRepository repository, ModelMapperService modelMapperService, ColorBusinessRulesService colorBusinessRulesService) {
        super(repository, modelMapperService, GetColorResponse.class, GetColorListResponse.class, Color.class, AddColorRequest.class, UpdateColorRequest.class);
